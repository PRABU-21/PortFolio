...
Activity
        ...
        <div className="max-w-lg mx-auto">
          {/* LeetCode Stats */}
          <div className="bg-[#000000] border border-neutral-800 rounded-2xl p-4 max-w-lg mx-auto">
            <div className="flex items-center gap-2 mb-4">
              <div className="w-8 h-8 rounded-lg bg-amber-500/10 flex items-center justify-center">
                <span className="text-amber-500 text-lg font-mono">{'</>'}</span>
              </div>
              <h3 className="text-xl font-bold text-[#E8E3B1]">LeetCode</h3>
            </div>
            
            <div className="flex items-center justify-center bg-neutral-800/30 rounded-lg mb-4">
              <img 
          ...
          <div className="bg-[#000000] border border-neutral-800 rounded-2xl p-4 max-w-lg mx-auto">
            <div className="flex items-center gap-2 mb-4">
              <div className="w-8 h-8 rounded-lg bg-amber-500/10 flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-5 h-5" style={{ fill: 'rgb(212,175,55)' }}>
              ...
              <h3 className="text-xl font-bold text-[#E8E3B1]">GitHub Activity</h3>
            </div>
            <div className="w-full flex justify-center bg-neutral-800/30 rounded-lg mb-4 p-2">
              <img 
