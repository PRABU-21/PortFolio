  ...
  return (
    <section className="min-h-screen flex items-center justify-center px-4">
      <div className="text-center max-w-4xl mx-auto">
        ...
        {/* Title */}
        <h2
          className="text-xl md:text-2xl text-amber-100/90 mb-6 font-light animate-fade-in-up"
          style={{ animationDelay: "0.2s" }}
        >
          Software Development Engineer | AI-Driven Systems & Full-Stack
          Development
        </h2>

        {/* Description */}
        <p
          className="text-lg md:text-xl text-amber-100/70 mb-12 max-w-2xl mx-auto animate-fade-in-up"
          style={{ animationDelay: "0.4s" }}
        >
          Building scalable, production-ready systems with strong
