    ...
    >
      <div className="max-w-6xl mx-auto w-full">
          ...
          <div className="text-white space-y-6">
            ...
            <FadeInSection delay={400}>
              <p className="text-lg text-[#E8E3B1]/80 leading-relaxed">
                AI & Software Developer crafting intelligent systems with LLMs,
                ML, and modern web technologies — turning ideas into impactful,
                real-world products.
              </p>
            </FadeInSection>
            {/* Quick Info */}
            <FadeInSection delay={500}>
              <div className="space-y-3 pt-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-[#E8E3B1]/80">+91 70103 84271</span>
                </div>
              </div>
            </FadeInSection>
            ...
            <FadeInSection delay={600}>
              <div className="pt-6">
                ...
                <p className="text-[#E8E3B1]/80">
                  AI & Machine Learning, Full-Stack Web Development, Large
                  Language Models (LLMs), Scalable Software Engineering
                </p>
              </div>
            </FadeInSection>
          </div>
        ...
        <div className="mt-20">
          ...
          <FadeInSection delay={200}>
            <LogoLoop
              logos={techSkills.map((skill) => ({
                node: (
                  <div className="group flex flex-col items-center gap-2 transition-all duration-300 cursor-pointer">
                    ...
                    <span className="text-white text-[10px] font-medium text-center opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
                      {skill.name}
                    </span>
                  </div>
                ),
