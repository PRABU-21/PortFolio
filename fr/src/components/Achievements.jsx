  ...
  const achievements = [
    {
      ...
      description: "Won first place in the prestigious annual technology festival's project exhibition competition.",
      ...
      imageUrl: "/achievement-images/techno-fest.jpg"
    },
    {
      id: 2,
      title: "2nd Place - KEC Hacknovate Hackathon 2024",
      description: "Secured second position in the competitive hackathon event focusing on innovative solutions.",
      technologies: ['Hackathon', 'Teamwork', 'Problem Solving'],
      impact: "Demonstrated rapid prototyping and collaborative development skills",
    ...
    },
    {
      ...
      description: "Won first place in the technical paper presentation competition for research excellence.",
      technologies: ['Research', 'Presentation', 'Technical Writing'],
      impact: "Showcased research capabilities and communication skills",
      accuracy: "First Position",
      imageUrl: "/achievement-images/paper-presentation.jpg"
    }
  ];
              ...
              <div className="space-y-4 h-full flex flex-col">
                ...
                <div className="space-y-2 flex-grow">
                  ...
                  <div className="inline-block px-2 py-1 bg-amber-500/10 border border-amber-500/30 rounded-full">
                    <span className="text-amber-300 text-xs font-medium">{achievement.accuracy}</span>
                  </div>
                </div>
                ...
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    <p className="text-yellow-100/80 text-xs italic truncate">{achievement.impact}</p>
                  </div>
                </div>
              </div>
            </SpotlightCard>
